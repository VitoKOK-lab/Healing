...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* Hero:桌面用橫式 Banner、行動用直式 App 封面 */}
      <section className="mx-auto max-w-6xl px-5 pb-20 pt-10">
        <div className="animate-rise overflow-hidden rounded-lg border border-hairline shadow-card">
        ...
        <div className="mt-12 text-center">
          ...
          <h1 className="mt-5 animate-rise font-serif-tc text-4xl font-semibold leading-relaxed sm:text-5xl">
            {brand.tagline}
          </h1>
